...
public class ComprasPorCliente implements java.io.Serializable, Comparable<ComprasPorCliente> {
     ...
     */
    private static TreeMap<String, ComprasDoProduto> copiaMap(Map<String, ComprasDoProduto> map){
        /* o fator de carga de um TreeMap é 0.75 por omissão. Ao inicializarmos a cópia de map  *
         * com o tamanho (int) Math.ceil(map.size() / 0.75) evitamos a realização de rehashing. */
        TreeMap<String, ComprasDoProduto> novoMap = new TreeMap<>();
