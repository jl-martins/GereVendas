...
public class Filial implements java.io.Serializable{
    ...
    public Filial(){
        ...
        for(int i = 0; i < 26; i++){
            clientesOrdenados.add(new TreeMap<>());
        }
    }
     ...
     */
    private static TreeMap<String, ComprasPorCliente> copiaMap(Map<String, ComprasPorCliente> map){
        TreeMap<String, ComprasPorCliente> novoMap = new TreeMap<>();
    ...
    public Map<String, ParQtdValor> mapClienteParQtdValor(String codigoProduto){
        Map<String, ParQtdValor> res = new TreeMap<>();
