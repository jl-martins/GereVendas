...
public class Venda implements Serializable {
    ...
    /**
     * Faz o <i>parsing</i> de um {@code ArrayList<String>} para um {@code TreeSet<Venda>}.
     * @param linhas Lista de Strings, em cada String tem os dados de uma venda.
     * 
     * @return <code>ArrayList</code> de objetos do tipo Venda, resultante do <i>parsing</i> de <code>linhas</code> 
     */
    public static TreeSet<Venda> parseAllLinhasToSet(ArrayList<String> linhas){
        TreeSet<Venda> vendas = new TreeSet<>();
