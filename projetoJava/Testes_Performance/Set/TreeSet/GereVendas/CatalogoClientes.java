...
public class CatalogoClientes implements Serializable{
    ...
    public CatalogoClientes(){
        codigosClientes = new TreeSet<>(); // permite inserir e consultar códigos de clientes em tempo tendencialmente constante.
    }
    ...
    public CatalogoClientes(CatalogoClientes c){
        this.codigosClientes = new TreeSet<>(c.codigosClientes);
    }
